                ...
                <div className="space-y-16 text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <div className="prose prose-invert max-w-none prose-headings:font-bold prose-headings:text-white prose-p:text-gray-300 prose-p:leading-relaxed prose-strong:text-white prose-strong:font-semibold">
                            <p className="text-lg text-gray-300 font-medium leading-relaxed">
                                <span className="text-white font-bold">StayIn Core</span> (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) operates the StayIn Core platform. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services.
                            </p>
                            <p className="mt-4">
                                By using the platform, you agree to the collection and use of information in accordance with this policy. We prioritize transparency and only request data necessary for fundamental operational functionality.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                { title: "Email & Contact Details", desc: "Used explicitly for account registration and secure authentication workflows." },
                                { title: "Name & Profile Information", desc: "Voluntarily provided by you within the secure container to personalize your experience." },
                                { title: "Property Data", desc: "Details about the properties and hotels you manage on the StayIn Core platform." },
                                { title: "Guest Data", desc: "Data entered regarding guests staying at the properties, securely stored for operational tracking." },
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                            {[
                                ...
                                "Processing property management transactions and data",
                                "Orchestration of staff and guest operations modules",
                    ...
                    <section className="p-8 bg-gradient-to-b from-white/[0.03] to-transparent rounded-[32px] border border-white/[0.06]">
                        ...
                        <p className="text-sm text-gray-400 mb-6">To deliver high-tier system reliability, StayIn Core relies strictly on standardized industrial pipelines that maintain independent governance structures:</p>
                    ...
                    <div className="space-y-12 border-t border-white/10 pt-12">
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400 leading-relaxed">Your logical profile is maintained strictly through the active duration of your relationship. To delete your account, email <span className="text-white font-bold">info.zenbourg@gmail.com</span> with your registered email. We will delete your account and data within 7 business days.</p>
                            </div>
                        </div>
                    </div>
