                ...
                <div className="space-y-16 text-gray-300 leading-relaxed">
                    ...
                    <section className="bg-purple-500/5 border border-purple-500/10 rounded-3xl p-6 md:p-8 flex gap-6 items-start">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400 leading-relaxed">
                                By accessing, or activating your workspace within the <span className="text-white font-bold">StayIn Core</span> platform, you explicitly assent to be legally bound by the terms explicitly articulated hereafter. Non-concurrence mandates immediate cessation of platform interaction.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-sm text-gray-400 mb-6">
                            These Standard Service Terms orchestrate the operational usage criteria of the digital ecosystems proprietary to <span className="text-white font-bold">StayIn Core</span>, governing relations between StayIn Core (&quot;Company&quot;) and the utilizing entity (&quot;User,&quot; &quot;Hotel,&quot; or &quot;Guest&quot;).
                        </p>
                        <ul className="space-y-4">
                            {[
                                { title: "Platform Utility", text: "StayIn Core functions strictly as a property management system and ecosystem connecting validated properties with guests and internal staff." },
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <section className="p-6 bg-white/[0.02] border border-white/[0.06] rounded-[28px]">
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed">
                                Safeguarding algorithmic authentication artifacts represents a strictly absolute non-transferable user mandate. The Company asserts zero responsibility for downstream unauthorized ecosystem exploitation leveraging compromised local user device states.
                            </p>
                        </section>
                        ...
                        <section className="p-6 bg-white/[0.02] border border-white/[0.06] rounded-[28px]">
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed">
                                All ecosystem debits facilitate via certified partner gateways (Razorpay). All finalize states remain non-retractable, subject strictly to explicit standalone documented cancellation policy overrides native to concrete individual venue operators or software subscriptions.
                            </p>
                        </section>
                    </div>
                    ...
                    {/* Booking Policy */}
                    <section>
                        <h3 className="text-xl font-bold text-white mb-6 tracking-tight">4. Dynamic Operations & Fulfilment</h3>
                        <div className="space-y-4 text-sm text-gray-400">
                            <p>
                                Users explicitly recognize that while StayIn Core facilitates the logistical bridge between parties, physical service provisioning remains a non-transferable liability exclusively bound to the physical venue management hierarchy.
                            </p>
                            <p>
                    ...
                    <section className="p-8 border border-red-500/10 bg-red-900/5 rounded-[32px]">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed font-medium italic uppercase tracking-tight">
                            TO THE MAXIMUM LATITUDE CONCEDED BY STATUTE, STAYIN CORE EXPLICITLY RENOUNCES ANY DIRECT, SECONDARY, OR RELATIONAL DAMAGES STEMMING FROM REAL-WORLD VENUE INCIDENTS, TECHNOLOGICAL LATENCY VECTORS, DATA LAGS, OR UNAPPROVED ACTS ORIGINATING FROM THIRD-PARTY NODES BEYOND DIRECT CODEBASE AUTHORITY.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-sm text-gray-500">
                            StayIn Core preserves the autonomous right to modify active programmatic frameworks or contractual covenants arbitrarily. Sustained application interaction post-mutation constitutes algorithmic verification of continued implicit acceptance.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-sm text-gray-500">
                            To delete your StayIn Core account, email <span className="text-white font-bold">info.zenbourg@gmail.com</span> with your registered email. We will delete your account and data within 7 business days.
                        </p>
                    </section>
